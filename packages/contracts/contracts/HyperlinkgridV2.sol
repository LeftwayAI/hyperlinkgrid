...
contract HyperlinkgridV2 is ERC721, Ownable, IEntropyConsumer {
    // =============================================================
    //                           CONSTANTS
    // =============================================================
    ...
    uint256 public constant NUM_BENEFICIARIES = 10;
    ...
    function buyNextTile(uint24 _color, string calldata _url) external {
        ...
        // V1 sent it to devTreasury. V2 holds it for the "Pot".
    ...
    function entropyCallback(
        ...
        // Use randomness to pick 10 unique winners
        // Simple shuffle-like selection
        uint256[] memory pool = new uint256[](MAX_SUPPLY);
        for(uint256 i=0; i<MAX_SUPPLY; i++) {
            pool[i] = i + 1; // IDs 1 to 10000
        }

        // Fisher-Yates shuffle (partial) to pick 10
